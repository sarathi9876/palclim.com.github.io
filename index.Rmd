...
<div class="palclim-about" style="background: white; border-radius: 16px; box-shadow: 0 4px 14px rgba(0,0,0,0.08); padding: 30px; margin-bottom: 30px; color: #0d47a1; font-size: 16px; line-height: 1.6; text-align: justify;">
  ...
  <p>
    ...
    </b>, a postdoctoral researcher at the University of São Paulo, Brazil.
  </p>
  <p style="font-style: italic; font-weight: 350;">
    This website and its services are personally funded by Dr. Jena without any sponsorship. If you find PalClim useful in your research or teaching, you're warmly welcome to support its development and future tools. If you know Dr. Jena personally contact him for donations. 
  </p>
</div>
